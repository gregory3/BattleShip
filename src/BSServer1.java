		...
		try {
			...
			while (true) {
				...
				if (turn) {
					...
					// Modify player2 object after being attacked and send to
					// user2
					...
					// Modify player1 object after attacking and send to player
					// 1
				...
				// Player 2 turn
					...
					// Modify player 1 object after being attacked and send to
					// user 1
					...
					// Modify player 2 object after attacking and send to player
					// 2
